...
export const useSalesData = () => {
  ...
  const executeReset = () => {
    localStorage.removeItem('meeza_pos_invoices');
    localStorage.removeItem('meeza_pos_returns');
    localStorage.removeItem('meeza_pos_expenses');
    localStorage.removeItem('meeza_pos_inventory');
    window.location.reload();
  };

  // Add emptyReturnBin to the returned object
  return { 
    invoices, 
    returns, 
    expenses, 
